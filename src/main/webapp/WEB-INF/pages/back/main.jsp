                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/res/ace/assets/images/avatars/avatar.png" class="msg-photo"
                                             alt="Alex's Avatar"/>
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/res/ace/assets/images/avatars/avatar3.png" class="msg-photo"
                                             alt="Susan's Avatar"/>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/res/ace/assets/images/avatars/avatar4.png" class="msg-photo"
                                             alt="Bob's Avatar"/>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/res/ace/assets/images/avatars/avatar2.png" class="msg-photo"
                                             alt="Kate's Avatar"/>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/res/ace/assets/images/avatars/avatar5.png" class="msg-photo"
                                             alt="Fred's Avatar"/>
                                        <span class="msg-body">
													<span class="msg-title">
        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <iframe name="content" src="/back/toWelcome" width="100%" height="750" frameborder="no"
                                border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="true"
                                id="my">
...
<script src="/res/scripts/sidebar-menu.js"></script>
    ...
    $(function () {
        $('#menu').sidebarMenu({
            data: [{
                ...
                menus: [{
                    ...
                    text: '品牌管理',
                    icon: 'fa fa-caret-right',
                    url: '/back/brand/toList'
                }, {
                    id: '22',
                    text: '商品管理',
                    icon: 'fa fa-caret-right',
                    url: '/back/product/toList'
                }]
            }, {
                id: '3',
                text: '权限管理',
        ...
        $('#exit').click(function () {
            layer.confirm('确定退出', {icon: 3}, function () {
                window.location.href = "/back/emp/exit";
            })
        })
    });
</script>
